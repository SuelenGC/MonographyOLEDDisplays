...
\begin{center}
    \vspace*{2.3cm}
    \textbf{\Large{Monografia: Flexible OLED Displays}}\\
    ...
    \vskip 2cm
    \textsc{
    Monografia sobre  \\[-0.25cm]     
    Flexible OLED Displays\\[-0.25cm]
    Universidade de São Paulo\\[-0.25cm]
    para disciplina de \\[-0.25cm]   
    Computação Móvel}
...
\input cap-introduction         % associado ao arquivo: 'cap-introduction.tex'
\input cap-research             % associado ao arquivo: 'cap-research.tex'
\input cap-fundamentacao        % associado ao arquivo: 'cap-fundamentacao.tex'
\input cap-oled                 % associado ao arquivo: 'cap-oled.tex'
\input cap-conclusions          % associado ao arquivo: 'cap-conclusions.tex'
