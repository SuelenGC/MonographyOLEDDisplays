...
\begin{figure}[!h]
  \centering
  \includegraphics[width=.40\textwidth]{plasma_display} 
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=.40\textwidth]{camadas_plasma} 
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=.40\textwidth]{camadas_lcd} 
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=.40\textwidth]{camadas_led} 
